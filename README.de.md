...
👉 **[Live Demo](https://pulse.goork.de/GHJGCM)** | **[Quellcode](https://github.com/thefraggle/pulse)**
...
*Stack:* Vanilla HTML/CSS/JS (ohne Framework)  
👉 **[notthoff.org besuchen](https://notthoff.org)**

**[schlawinerdogs.de](https://schlawinerdogs.de)** – Eine responsive Landingpage für eine Beißkorb-Beratung.  
*Stack:* Vanilla HTML/CSS/JS  
👉 **[schlawinerdogs.de besuchen](https://schlawinerdogs.de)**

#### ⚙️ Self-Hosted, Automation & Infrastruktur
**Forgejo Git-Infrastruktur** – Meine selbstgehostete Forgejo-Instanz als primäre Entwicklungsplattform und Haupt-Repository, mit automatisiertem Push-Mirroring und Backup-Replikation nach GitHub.  
*Stack:* Forgejo, Git, Docker, Bash

**n8n Automation ("Neo")** – Mein selbstgehosteter Telegram-basierter KI-Assistent „Neo“, gesteuert über 15+ n8n Workflows, GPT-4o und diverse Tools (Mail-Klassifizierung, Kalender-Sync, Web-Recherche).  
*Stack:* n8n, Node.js, Docker, Nginx Proxy Manager, OpenAI API

**Paperless-ngx** – Selbstgehostetes Dokumenten-Management-System mit automatischer OCR-Texterkennung und Archivierung für die papierlose Organisation.  
...
**Aptabase & TeleGoork Analytics** – Selbstgehostete, datenschutzfreundliche In-App-Telemetrie für mobile Apps auf Basis von ClickHouse & PostgreSQL, aggregiert in einem eigenen Mobile-First PWA-Dashboard.  
...
[![Forgejo](https://img.shields.io/badge/Forgejo-%23F25923.svg?style=for-the-badge&logo=forgejo&logoColor=white)](https://forgejo.org/)
...
### 💬 Lass uns vernetzen!
[![Website](https://img.shields.io/badge/notthoff.org-My_Hub-222222?style=for-the-badge&logo=safari&logoColor=white)](https://notthoff.org)
...
*“Stay hungry, stay foolish (and drink more coffee).”* ☕️

[![Umami telemetry](https://telemetry.goork.de/p/huUqAzoUK)](https://telemetry.goork.de)